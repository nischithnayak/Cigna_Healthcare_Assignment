...
INSERT INTO Authors (Author_ID, Author_Name) VALUES (1, 'Reddy');
INSERT INTO Authors (Author_ID, Author_Name) VALUES (2, 'Shankar');

INSERT INTO Books (Book_ID, Title, Author_ID, ISBN, Publication_Year, Available_Copies)
VALUES (1, 'Harry Potter', 1, '9780747532743', 1997, 5);
INSERT INTO Books (Book_ID, Title, Author_ID, ISBN, Publication_Year, Available_Copies)
VALUES (2, 'Think and Grow Rich', 2, '9780261103344', 1937, 3);

INSERT INTO Members (Member_ID, Member_Name, Address, Phone)
VALUES (1, 'James', '123 BLR St, City', '123-456-7890');
INSERT INTO Members (Member_ID, Member_Name, Address, Phone)
VALUES (2, 'Smith', '456 BLR St, Town', '987-654-3210');
